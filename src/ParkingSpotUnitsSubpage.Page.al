page 50106 "Parking Spot Units Subpage"
{
    Caption = 'Parking Spot Units Subpage';
    PageType = ListPart;
    Editable = true;
    ApplicationArea = All;
    UsageCategory = None;
    ...
    layout
    {
        area(Content)
        {
            repeater(GroupName)
            {
                ...
                {
                    ToolTip = 'Specifies if the parking spot unit is currently blocked from being rented out.';
                }
            }
        }
    }
